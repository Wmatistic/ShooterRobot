...
public class ShooterLUT {
    ...
    public ShooterLUT() {
        ...
        table.put(170.0, new ShotConfig(1600, 0.8, 0.0));
        table.put(134.0, new ShotConfig(1400, 0.8, 0.0));
        table.put(93.0, new ShotConfig(1200, 0.8, 0.0));
        table.put(75.0, new ShotConfig(1100, 0.6, 0.0));
